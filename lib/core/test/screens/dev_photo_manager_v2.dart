...
class DevPhotoManagerV2 extends StatefulWidget {
  static String routeName = "dev/photo_manager/v2";
  const DevPhotoManagerV2({Key? key}) : super(key: key);

  @override
  _DevPhotoManagerV2State createState() => _DevPhotoManagerV2State();
}

class _DevPhotoManagerV2State extends State<DevPhotoManagerV2> {
  ...
  _handleScrollEvent(ScrollNotification scroll, FileModel selectModel) {
  ...
  _fetchNewMedia() async {
    ...
    if (result) {
      ...
      print("selectedModel: ${selectedModel!.album}");
    } else {
      // fail
